...
insert  into `cotizaciones`(`id`,`codigo`,`fecha_creacion`,`titulo`,`descripcion`,`neto`,`iva`,`iva_historico`,`total`,`fecha_actualizacion`,`usuarios_id`,`clientes_id`,`neto_real`,`iva_real`,`total_real`,`cotizaciones_estado_id`) values (1,'1','2023-04-10 21:04:16','Cotización 1','Cotización 1',500,95,0.19,595,'2023-04-11 23:57:17',1,1,0,0,0,1),(2,'2','2023-04-10 21:12:47','Cotización 2','Cotización 2',600,114,0.19,714,'2023-04-11 23:57:21',1,1,0,0,0,1);
...
insert  into `detalle_cotizacion`(`id`,`cotizaciones_id`,`items_id`,`n_linea`,`cantidad`,`valor`) values (1,1,1,1,1,200),(2,1,2,2,1,300),(3,2,1,1,3,200);
