...
MySQL - 8.0.31 : Database - gestion_md
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gestion_md` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `clientes` (
  ...
  `rut` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `comuna` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `rut` (`rut`)
...
CREATE TABLE `configuraciones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `acronimo` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parametro` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valor` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
insert  into `cotizacion_material_presupuestado`(`cotizacion_id`,`material_id`,`cantidad`) values (4,3,2),(1,19,1),(2,1,10),(2,2,43),(1,1,20),(4,1,6);
...
insert  into `cotizacion_material_real`(`cotizacion_id`,`material_id`,`cantidad`) values (1,2,3),(1,1,15),(2,1,2),(2,2,4),(1,15,5),(4,3,1),(4,1,2);
...
CREATE TABLE `cotizaciones` (
  ...
  `neto_real` int DEFAULT '0',
  `iva_real` int DEFAULT '0',
  `total_real` int DEFAULT '0',
  `cotizaciones_estado_id` int DEFAULT '1',
...
insert  into `cotizaciones`(`id`,`codigo`,`fecha_creacion`,`titulo`,`descripcion`,`neto`,`iva`,`iva_historico`,`total`,`fecha_actualizacion`,`usuarios_id`,`clientes_id`,`neto_real`,`iva_real`,`total_real`,`cotizaciones_estado_id`,`fecha`) values (1,'1','2023-04-25 04:18:48','Cotización 1','Cotización 122',4500,855,0.19,5355,'2023-05-10 05:32:53',1,1,400,76,476,1,'2023-04-25 00:00:00'),(2,'2','2023-04-25 23:42:35','Cotización 2','Cotización 2',600,114,0.19,714,'2023-04-25 23:42:35',1,1,0,0,0,1,'2023-04-10 00:00:00'),(3,'P 3','2023-04-25 23:02:35','P 3','pp 33',7000,1330,0.19,8330,'2023-04-25 23:02:35',1,2,8500,1615,10115,1,'2023-04-25 00:00:00'),(4,'555','2023-05-10 05:45:24','titulo 555','titulo 555555',1500,285,0.19,1785,'2023-05-10 05:47:46',1,1,750,143,893,1,'2023-05-10 00:00:00');
...
CREATE TABLE `detalle_cotizacion` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cotizaciones_id` int DEFAULT NULL,
  `items_id` int DEFAULT NULL,
  `n_linea` smallint DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
...
insert  into `detalle_cotizacion`(`id`,`cotizaciones_id`,`items_id`,`n_linea`,`cantidad`,`valor`) values (14,3,4,1,5,1000),(15,3,1,2,1,1000),(16,3,3,3,1,1000),(18,2,1,1,3,200),(34,1,1,1,1,200),(35,1,2,2,1,300),(36,1,3,3,4,1000),(38,4,1,1,1,1000),(39,4,2,2,1,500);
...
insert  into `detalle_cotizacion_real`(`id`,`cotizaciones_id`,`items_id`,`n_linea`,`cantidad`,`valor`) values (12,3,4,1,5,500),(13,3,1,2,1,500),(14,3,2,3,1,1000),(15,3,5,4,1,4500),(26,1,1,1,1,100),(27,1,2,2,2,150),(29,4,1,1,1,500),(30,4,2,2,1,250);
...
CREATE TABLE `logs` (
  ...
  `entidad` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `materiales` (
  ...
  `codigo` int NOT NULL,
  `nombre` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `modelo` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `serviciosfinalizados` (
  ...
  `iva` int DEFAULT NULL,
  `total` int DEFAULT NULL,
  `iva_historico` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
